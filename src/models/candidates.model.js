...
export const indexes = [
  { key: { position_id: 1, candidate_number: 1, period_start: 1, period_end: 1 }, unique: true },
  { key: { user_id: 1 } },
  { key: { deleted_at: 1 } },
  { key: { status: 1 } },
...
export const searchableFields = ['name', 'profile', 'vision_mission', 'program_kerja', 'status'];